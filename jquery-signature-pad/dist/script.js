            ...
            onEvent: function (e) {
                switch (e.type) {
                    ...
                    case 'mouseup':
                        ...
                        console.log(e.pageX - this.canvas.offset().left)
                        console.log(e.pageY - this.canvas.offset().top)
...
(function ($) {
    $.fn.SignaturePad = function (options) {
        ...
        //init the signpad
        if (canvas) {
            var sign1big = $(canvas).sketch({ defaultColor: "#000", defaultSize: 1 });
        }
        ...
        return this.each(function () {
            ...
            // document.getElementById("txt").display="hidden";
